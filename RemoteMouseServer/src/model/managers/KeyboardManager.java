...
public class KeyboardManager {
    ...
    private int getKeyCode(String key){
        ...
        if(key.equals("ENTER")){ return KeyEvent.VK_ENTER;}
        else if(key.equals("BACK_SPACE")){ return KeyEvent.VK_BACK_SPACE;}
        else if(key.equals("TAB")){ return KeyEvent.VK_TAB;}
        else if(key.equals("CAPS_LOCK")){ return KeyEvent.VK_CAPS_LOCK;}
        else if(key.equals("LEFT")){ return KeyEvent.VK_LEFT;}
        else if(key.equals("UP")){ return KeyEvent.VK_UP;}
        ...
        else if(key.equals("3")){ return KeyEvent.VK_3;}
        else if(key.equals("4")){ return KeyEvent.VK_4;}
        else if(key.equals("5")){ return KeyEvent.VK_5;}
        else if(key.equals("6")){ return KeyEvent.VK_6;}
        ...
        else if(key.equalsIgnoreCase("D")){ return KeyEvent.VK_D;}
        else if(key.equalsIgnoreCase("E")){ return KeyEvent.VK_E;}
        else if(key.equalsIgnoreCase("F")){ return KeyEvent.VK_F;}
        else if(key.equalsIgnoreCase("G")){ return KeyEvent.VK_G;}
        else if(key.equalsIgnoreCase("H")){ return KeyEvent.VK_H;}
        else if(key.equalsIgnoreCase("I")){ return KeyEvent.VK_I;}
        else if(key.equalsIgnoreCase("J")){ return KeyEvent.VK_J;}
        else if(key.equalsIgnoreCase("K")){ return KeyEvent.VK_K;}
        else if(key.equalsIgnoreCase("L")){ return KeyEvent.VK_L;}
        else if(key.equalsIgnoreCase("M")){ return KeyEvent.VK_M;}
        else if(key.equalsIgnoreCase("N")){ return KeyEvent.VK_N;}
        else if(key.equalsIgnoreCase("O")){ return KeyEvent.VK_O;}
        else if(key.equalsIgnoreCase("P")){ return KeyEvent.VK_P;}
        else if(key.equalsIgnoreCase("Q")){ return KeyEvent.VK_Q;}
        else if(key.equalsIgnoreCase("R")){ return KeyEvent.VK_R;}
        else if(key.equalsIgnoreCase("S")){ return KeyEvent.VK_S;}
        else if(key.equalsIgnoreCase("T")){ return KeyEvent.VK_T;}
        else if(key.equalsIgnoreCase("U")){ return KeyEvent.VK_U;}
        else if(key.equalsIgnoreCase("V")){ return KeyEvent.VK_V;}
        else if(key.equalsIgnoreCase("W")){ return KeyEvent.VK_W;}
        ...
        else if(key.equals("€")){ return KeyEvent.VK_EURO_SIGN;}
        else if(key.equals("!")){ return KeyEvent.VK_EXCLAMATION_MARK;}
        else if(key.equals("¡")){ return KeyEvent.VK_INVERTED_EXCLAMATION_MARK;}
